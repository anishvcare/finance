...
class TaskController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'parent_id' => ['nullable', $this->existsInWorkspace('tasks')],
            'assignee_id' => ['nullable', $this->existsAsWorkspaceMember()],
            'customer_id' => ['nullable', $this->existsInWorkspace('customers')],
            'supplier_id' => ['nullable', $this->existsInWorkspace('suppliers')],
            'invoice_id' => ['nullable', $this->existsInWorkspace('invoices')],
            'bill_id' => ['nullable', $this->existsInWorkspace('bills')],
            'commitment_id' => ['nullable', $this->existsInWorkspace('commitments')],
            'tags' => 'nullable|array',
